...
@section('content')
    <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center items-center">
        <div class="max-w-screen-xl h-[80vh] sm:m-10 bg-white rounded-lg shadow sm: flex justify-center flex-1">
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                @if ($errors->any())
                    <div class="w-[80%] mx-auto bg-red-300 font-medium text-red-700 rounded-lg px-[2.5%] py-[0.5rem] mb-[1rem]">
                        <ul>
                ...
                <div class="mt-6 flex flex-col items-center">
                    ...
                    <div class="w-full flex-1 mt-5">
                        <div class="mx-auto max-w-xs">
                            <form method="POST" action="{{route('driverRegistration')}}">
                                @csrf
                                ...
                                <div class="mt-[0.75rem]">
                                    <select name="payment" class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none ">
                                ...
                                <a href="{{route('register')}}" class="text-gray-500 mt-[0.5rem] block underline">
